...
class Simulacion:
    ...
    def nuevo_dia(self) -> None:
        # Completar
        recolector1 = Recolector("Juan", self.centro_urbano)
        recolector2 = Recolector("Manuel", self.centro_urbano)
        constructor1 = Constructor("Franco", self.centro_urbano)
        constructor2 = Constructor("Camilo", self.centro_urbano) 
        recolector1.start()
        recolector2.start()
        constructor1.start()
        constructor2.start()
